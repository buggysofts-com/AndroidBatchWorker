...
public interface WorkerCallBack<T, V> {
     ...
     */
    @WorkerThread
    public void onLongPreWork(List<T> dataList);
     ...
     */
    public V performTask(List<T> dataList, int activeDataIndex);
     ...
     */
    public String taskLabelDescriptor(List<T> dataList, int activeDataIndex);
     ...
     */
    public String taskProgressDescriptor(List<T> dataList, int activeDataIndex);
     ...
     */
    @WorkerThread
    public void onLongPostWork(List<V> results);
